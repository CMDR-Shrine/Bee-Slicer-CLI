#!/bin/bash
#
# BEETHEFIRST Direct USB Printer Script
# Sends G-code line-by-line over USB (no SD card)
#
# Usage: ./print_direct.sh <gcode_file>
#
...
if [ -z "$1" ]; then
    ...
    echo ""
    echo "NOTE: This uses DIRECT USB printing (line-by-line)"
    echo "      Slower than SD card, but more reliable if SD doesn't work"
    exit 1
fi
...
echo "============================================================"
echo "BEETHEFIRST DIRECT USB PRINTER"
echo "============================================================"
echo "G-code file: $(basename "$GCODE_FILE")"
echo "Mode: Direct USB (line-by-line)"
echo "============================================================"
echo ""
...
# Run the direct print script
echo "[2/3] Connecting to printer..."
echo ""

python "$SCRIPT_DIR/print_direct.py" "$GCODE_FILE"
